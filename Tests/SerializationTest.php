...
class SerializationTest extends TestSerializationCase
{
    ...
    public function provideJsonErrorCodes()
    {
        ...
        yield ['label' => 'maximumNumberOfGuildsReached100', 'value' => 30001];
        yield ['label' => 'maximumNumberOfFriendsReached1000', 'value' => 30002];
        yield ['label' => 'maximumNumberOfPinsReachedForTheChannel50', 'value' => 30003];
        yield ['label' => 'maximumNumberOfRecipientsReached10', 'value' => 30004];
        yield ['label' => 'maximumNumberOfGuildRolesReached250', 'value' => 30005];
        yield ['label' => 'maximumNumberOfWebhooksReached10', 'value' => 30007];
        yield ['label' => 'maximumNumberOfEmojisReached', 'value' => 30008];
        yield ['label' => 'maximumNumberOfReactionsReached20', 'value' => 30010];
        yield ['label' => 'maximumNumberOfGuildChannelsReached500', 'value' => 30013];
        yield ['label' => 'maximumNumberOfAttachmentsInAMessageReached10', 'value' => 30015];
        yield ['label' => 'maximumNumberOfInvitesReached1000', 'value' => 30016];
        yield ['label' => 'maximumNumberOfAnimatedEmojisReached', 'value' => 30018];
        yield ['label' => 'maximumNumberOfServerMembersReached', 'value' => 30019];
        yield ['label' => 'maximumNumberOfServerCategoriesHasBeenReached5', 'value' => 30030];
        ...
        yield ['label' => 'requestEntityTooLargeTrySendingSomethingSmallerInSize', 'value' => 40005];
        ...
        yield ['label' => 'providedTooFewOrTooManyMessagesToDeleteMustProvideAtLeast2AndFewerThan100MessagesToDelete', 'value' => 50016];
        ...
        yield ['label' => 'invalidFormBodyReturnedForBothApplicationJsonAndMultipartFormDataBodiesOrInvalidContentTypeProvided', 'value' => 50035];
        ...
        yield ['label' => 'apiResourceIsCurrentlyOverloadedTryAgainALittleLater', 'value' => 130000];
